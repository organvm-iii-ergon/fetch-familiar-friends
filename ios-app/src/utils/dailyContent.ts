 ...
 */
export function getDailyFact(date: Date, isCat = false): string {
 ...
 * Get mood of the day
 */
export function getDailyMood(date: Date): Mood {
  const seed = getDateSeed(date);
...
export function getAllDailyContent(date: Date, isCat = false): DailyContent {
  return {
