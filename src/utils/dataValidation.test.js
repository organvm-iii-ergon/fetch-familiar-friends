...
describe("validateString", () => {
  it("should validate correct strings", () => {
    ...
    expect(validateString("hello world", "field", { minLength: 5 }).valid).toBe(
      true,
    );
  });
  ...
  it("should validate string length", () => {
    ...
    const result2 = validateString("this is a very long string", "field", {
      maxLength: 10,
    });
  ...
  it("should validate string patterns", () => {
    ...
    expect(
      validateString("invalid-email", "email", { pattern: emailPattern }).valid,
    ).toBe(false);
  });
});
...
describe("validateArray", () => {
  ...
  it("should validate array length", () => {
    ...
    expect(validateArray([1, 2, 3, 4], "field", { maxLength: 3 }).valid).toBe(
      false,
    );
  });
});
...
describe("validateContentData", () => {
  it("should validate correct content data", () => {
    const content = {
      ...
      catFacts: ["Cats spend 70% of their lives sleeping."],
      quotes: ["Dogs are a man's best friend."],
      moods: [
...
describe("isFamilyFriendly", () => {
  it("should pass family-friendly content", () => {
    ...
    expect(isFamilyFriendly("Have a great day with your furry friend!")).toBe(
      true,
    );
  });
  ...
  it('should handle false positives (e.g. "class" containing "ass")', () => {
    expect(isFamilyFriendly("I have a class today")).toBe(true);
    expect(isFamilyFriendly("Hello there")).toBe(true);
    expect(isFamilyFriendly("Assign a variable")).toBe(true);
  });
});
